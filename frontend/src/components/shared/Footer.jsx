        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://twitter.com" className="text-gray-400 hover:text-gray-100" aria-label="Twitter">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://linkedin.com" className="text-gray-400 hover:text-gray-100" aria-label="LinkedIn">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
